...
# CONTEXT_MANIFEST — A2-QUALITY-RELEASE
...
- `Receipts_Final_Architecture.md` — §§V, W, §T, invariants 9 and 10, and the closing falsification section
- `architecture-decisions/ARCHITECTURE_DEVIATION_REQUEST_001.md` — hook documentation must reflect it
- `orchestration/12_EVIDENCE_REQUIREMENTS.md`, `13_RELEASE_GATES.md`, `11_INTEGRATION_GATES.md`, `05_MILESTONE_PLAN.md`, `10_OPEN_ISSUES.md`
- `contracts/CONTRACT_INDEX.md`
- `contracts/CONTRACT_CLI_001.md`, `CONTRACT_EXPORT_001.md` — the harness drives one and verifies with the other
- `A2_CONSOLIDATION_DECISION.md`, `A2_OWNERSHIP_REMAP.md`
- A2-TRUST's enforcement-scope audit, once it exists
- This manager file, `CONTEXT_MANIFEST.md`, `OWNERSHIP_MANIFEST.md`, `FIRST_MANAGER_TASK.md`

## CONSUMED

- `contracts/CONTRACT_POLICY_002.md`, `CONTRACT_CORE_003.md` — admission decisions and claim states you measure
- `contracts/CONTRACT_RUNNER_002.md` — receipt facts feeding metrics
- `contracts/CONTRACT_REVIEW_002.md` — review results and false-positive measurement
- `contracts/CONTRACT_OVERRIDE_001.md` — override frequency
- `orchestration/03`, `08`, `14`

## REFERENCE

- Every remaining frozen contract — you describe all of them in documentation and must quote them accurately
- `schemas/SCHEMA_PLAN.md`
- `orchestration/00`, `01`, `02`, `06`, `07`, `09`, `15`

## EXCLUDED / FOREIGN OWNERSHIP

You own no contract, so **every contract is foreign ownership**. None is EXCLUDED from *reading* — you document all of them — but all 21 are EXCLUDED from modification, absolutely.

All product source, schemas, and configuration are likewise read-only to you. Where documentation and a frozen contract disagree, the contract wins and your document is the defect.

## Contract classification — all 21 frozen contracts

| Contract | Subject | Owner | Your class |
|---|---|---|---|
| `CONTRACT_CORE_001.md` | CodeStateFingerprint | A2-FOUNDATION | REFERENCE |
...
| `CONTRACT_LEDGER_002.md` | Append-only event / projection invariants | A2-FOUNDATION | REFERENCE |
| `CONTRACT_EXPORT_001.md` | Portable ledger export | A2-FOUNDATION | CONSUMED |
