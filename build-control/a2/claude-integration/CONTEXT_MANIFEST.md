...
# CONTEXT_MANIFEST — A2-CLAUDE-INTEGRATION
...
- `Receipts_Final_Architecture.md` — §O, §T, §Y, §§Q/Z, and invariant 10
- `architecture-decisions/ARCHITECTURE_DEVIATION_REQUEST_001.md` — **read in full; it constrains you more than anyone**
...
- `contracts/CONTRACT_POLICY_002.md` — you cannot encode a gate without it
...
- **Current official Claude Code documentation**, re-verified at time of use — the only mandatory input that is not in this repository

## CONSUMED

- `contracts/CONTRACT_CORE_001.md`, `CONTRACT_CORE_002.md`, `CONTRACT_CORE_003.md` — facts you render
- `contracts/CONTRACT_CONFIG_001.md`, `CONTRACT_CONFIG_002.md` — deny-rule targets
- `contracts/CONTRACT_OVERRIDE_001.md` — override rendering rules
- `contracts/CONTRACT_REVIEW_003.md` — reviewer-agent packaging constraints
- `orchestration/03`, `08`, `14`

## REFERENCE

- `contracts/CONTRACT_POLICY_001.md`, `CONTRACT_EVIDENCE_001.md`, `CONTRACT_RUNNER_001.md`, `CONTRACT_RUNNER_002.md`, `CONTRACT_REVIEW_001.md`, `CONTRACT_REVIEW_002.md`, `CONTRACT_CONFIG_003.md`
- `orchestration/00`, `02`, `06`, `07`, `15`

## EXCLUDED / FOREIGN OWNERSHIP

- `contracts/CONTRACT_LEDGER_001.md`, `CONTRACT_LEDGER_002.md`, `CONTRACT_EXPORT_001.md` — storage internals are foreign; you reach the ledger only through the broker
...
| `CONTRACT_CORE_002.md` | Task + TaskState | A2-FOUNDATION | CONSUMED |
| `CONTRACT_CORE_003.md` | Claim + ClaimStatus | A2-FOUNDATION | CONSUMED |
| `CONTRACT_EVIDENCE_001.md` | Evidence families + Evidence | A2-FOUNDATION | REFERENCE |
...
| `CONTRACT_CONFIG_002.md` | .receipts/policy.yaml | A2-FOUNDATION | CONSUMED |
| `CONTRACT_LEDGER_001.md` | LedgerEvent | A2-FOUNDATION | EXCLUDED |
| `CONTRACT_LEDGER_002.md` | Append-only event / projection invariants | A2-FOUNDATION | EXCLUDED |
| `CONTRACT_EXPORT_001.md` | Portable ledger export | A2-FOUNDATION | EXCLUDED |
| `CONTRACT_RUNNER_001.md` | VerificationRecipe | A2-VERIFICATION | REFERENCE |
| `CONTRACT_RUNNER_002.md` | ExecutionReceipt | A2-VERIFICATION | REFERENCE |
| `CONTRACT_CONFIG_001.md` | .receipts/recipes.yaml | A2-VERIFICATION | CONSUMED |
| `CONTRACT_PLUGIN_001.md` | Normalized hook -> broker request | A2-CLAUDE-INTEGRATION | **OWNED** |
| `CONTRACT_PLUGIN_002.md` | Broker -> hook decision / error response | A2-CLAUDE-INTEGRATION | **OWNED** |
| `CONTRACT_CLI_001.md` | receipts CLI semantics + exit codes | A2-CLAUDE-INTEGRATION | **OWNED** |
| `CONTRACT_REVIEW_001.md` | ReviewRequest | A2-TRUST | REFERENCE |
| `CONTRACT_REVIEW_002.md` | ReviewResult + ReviewFinding | A2-TRUST | REFERENCE |
| `CONTRACT_REVIEW_003.md` | ReviewProvider | A2-TRUST | CONSUMED |
| `CONTRACT_CONFIG_003.md` | .receipts/providers.yaml | A2-TRUST | REFERENCE |
